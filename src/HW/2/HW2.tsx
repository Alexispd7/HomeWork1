...
export const HW2 = () => {
  ...
  const filterUsers = () => {
    const filteredUsers = users.myFriends.filter(address => address.address.city = 'Los Angeles') 'НУЖНО ПРОФИЛЬТРОВАТЬ ДРУЗЕЙ. ОСТАВЛЯЕМ ТОЛЬКО ТЕХ, КОТОРЫЕ ЖИВУТ В ГОРОДЕ LOS ANGELES';
